...
path_to_csv = '/home/y1u0d2/Result/rdf/rdf_atom'
    ...
    for i, file in enumerate(files):
        ...
        for j, s in enumerate(structure):
            ...
            for tmp in hist_insert:
                ...
                hist.insert(0, tmp)
            # csvファイル作成時にheader付与
            if not os.path.exists(f'{path_to_csv}/{name_of_structure}/{name_of_structure}_{center_atom}-{another_atom}.csv'):
