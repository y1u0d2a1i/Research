...
class ExtractData:
    ...
    def get_epoch(self,target_dir):
        obj = ConvertCsv(target_dir,self.root_dir)
        obj.convert_n2p2_output_to_csv(32,'learning-curve.out','tmp.csv')
    ...
    def copy_file(self, output_dir):
        ...
        shutil.copyfile(f'{self.root_dir}/testpoints.0000{epoch}.out ', output_dir)
        shutil.copyfile(f'{self.root_dir}/trainpoints.0000{epoch}.out ', output_dir)
